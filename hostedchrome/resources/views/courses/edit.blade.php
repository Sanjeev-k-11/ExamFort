...
<div style="max-width: 860px; margin: 0 auto;">
    <div style="margin-bottom: 24px;">
        <a href="{{ route('courses.show', $course->course_id) }}" style="color: #818cf8; text-decoration: none; font-size: 13px; font-weight: 600; display: inline-flex; align-items: center; gap: 6px; margin-bottom: 8px;">
            <i data-lucide="arrow-left" style="width: 14px; height: 14px;"></i>
            <span>Back to Course Overview</span>
        </a>
        <h1 style="font-size: 26px; font-weight: 800; color: #fff;">Edit Course Details</h1>
    </div>
        ...
        <form action="{{ route('courses.update', $course->course_id) }}" method="POST">
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control mono" value="{{ $course->course_id }}" readonly disabled style="opacity: 0.7;">
                </div>
            ...
            <div style="display: flex; gap: 12px; justify-content: flex-end; margin-top: 32px; padding-top: 20px; border-top: 1px solid var(--border-color);">
                <a href="{{ route('courses.show', $course->course_id) }}" class="quick-action-btn secondary">Cancel</a>
