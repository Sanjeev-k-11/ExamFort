...
<!-- GOOGLE GEMINI AI KEY CONFIGURATION CARD FOR TEACHER -->
<div class="glass-card" style="margin-bottom: 28px; background: linear-gradient(135deg, rgba(255, 255, 255, 0.95), rgba(240, 249, 255, 0.85)); border: 1px solid rgba(14, 165, 233, 0.3);">
        ...
        <div style="display: flex; align-items: center; gap: 14px;">
            ...
            <div>
                ...
                <p style="font-size: 12.5px; color: var(--text-secondary); margin-top: 2px;">
                    Powers AI Exam Question Paper Generation, AI Lesson Studios, and Descriptive Essay Evaluation.
                </p>
            </div>
        </div>
    ...
    <form action="{{ route('principals.updateGeminiKey') }}" method="POST" style="display: flex; gap: 12px; align-items: center; flex-wrap: wrap;">
        ...
        <div style="flex: 1; min-width: 320px; position: relative;">
            ...
            <input type="password" name="gemini_api_key" id="teacherGeminiKeyInput" class="form-control mono" style="padding-left: 40px; padding-right: 44px; font-size: 13px;" placeholder="Paste your Google Gemini API Key (e.g. AIzaSy...)" value="{{ $currentUser->gemini_api_key }}">
            <button type="button" onclick="const el = document.getElementById('teacherGeminiKeyInput'); el.type = el.type === 'password' ? 'text' : 'password';" style="position: absolute; right: 12px; top: 10px; background: none; border: none; color: var(--text-muted); cursor: pointer;">
